...
package floo_axi_mesh_noc_pkg;
  ...
  typedef enum logic[3:0] {
    ...
    ClusterX3Y3SamIdx = 15} sam_idx_e;
...
'{    idx: '{x: 0, y: 0, port_id: 0},
  ...
  localparam route_cfg_t RouteCfg = '{    RouteAlgo: XYRouting,
    ...
    typedef logic[47:0] axi_axi_in_addr_t;
typedef logic[63:0] axi_axi_in_data_t;
typedef logic[7:0] axi_axi_in_strb_t;
typedef logic[3:0] axi_axi_in_id_t;
typedef logic[0:0] axi_axi_in_user_t;
`AXI_TYPEDEF_ALL_CT(axi_axi_in,             axi_axi_in_req_t,             axi_axi_in_rsp_t,             axi_axi_in_addr_t,             axi_axi_in_id_t,             axi_axi_in_data_t,             axi_axi_in_strb_t,             axi_axi_in_user_t)


    typedef logic[47:0] axi_axi_out_addr_t;
typedef logic[63:0] axi_axi_out_data_t;
typedef logic[7:0] axi_axi_out_strb_t;
typedef logic[1:0] axi_axi_out_id_t;
typedef logic[0:0] axi_axi_out_user_t;
`AXI_TYPEDEF_ALL_CT(axi_axi_out,             axi_axi_out_req_t,             axi_axi_out_rsp_t,             axi_axi_out_addr_t,             axi_axi_out_id_t,             axi_axi_out_data_t,             axi_axi_out_strb_t,             axi_axi_out_user_t)
  ...
  localparam axi_cfg_t AxiCfg = '{    AddrWidth: 48,
    ...
    OutIdWidth: 2,
    UserWidth: 1};
`FLOO_TYPEDEF_AXI_CHAN_ALL(axi, req, rsp, axi_axi_in, AxiCfg, hdr_t)
